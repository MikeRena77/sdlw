...
REM
REM  6/14/13 NSN Add support for base1970
REM
REM  10/15/10 - put a full path on setvdisk.bat so another version doesn't
REM  accidentally get used.
REM
REM  Add support for base202, base209
REM
REM  Add support for base204, base208, base210 (NEXT)
REM
...
if "%1" == "1970" goto base1970:
if "%1" == "200" goto base200:
if "%1" == "202" goto base202:
if "%1" == "210" goto base210:
if "%1" == "209" goto base209:
if "%1" == "204" goto base204:
if "%1" == "208" goto base208:
...
:base195
echo get the setvdisk for base195 from pvcs.
...
:base1970
echo get the setvdisk for base1970 from pvcs.
get -vNEXT1970 -w -y q:\vcs\bin\setvdisk.bat
goto copyit:

:base202
echo get the setvdisk for base202 from pvcs.
get -vNEXT202 -w -y q:\vcs\bin\setvdisk.bat
goto copyit:

:base209
echo get the setvdisk for base209 from pvcs.
get -vNEXT209 -w -y q:\vcs\bin\setvdisk.bat
goto copyit:

:base200
echo get the setvdisk for base200 from pvcs.
get -vNEXT200 -w -y q:\vcs\bin\setvdisk.bat
goto copyit:

:base210
echo get the setvdisk for base210 from pvcs.
get -vNEXT -w -y q:\vcs\bin\setvdisk.bat
goto copyit:

:base204
echo get the setvdisk for base204 from pvcs.
get -vNEXT204 -w -y q:\vcs\bin\setvdisk.bat
goto copyit:

:base208
echo get the setvdisk for base208 from pvcs.
get -vNEXT208 -w -y q:\vcs\bin\setvdisk.bat
goto copyit:
...
echo  *        171, 172, 173, 190, 191, 195, 200, 202, 208  *
echo  *        209, 210                                     *
