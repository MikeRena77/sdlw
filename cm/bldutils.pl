...
#*  
#*     Rev 1.27   10 Jul 2012 12:03:58   JaciC
#*  Update the to handle Heartland HPS for the nmap project.
#*  
#*     Rev 1.26   14 Oct 2009 12:03:58   BLi
#*  Update the .NET DLL registration to use .NET 2.0 framework.
#*  
#*     Rev 1.25   24 Mar 2006 14:05:56   BLi
#*  Updated for project ADS.
#*  
#*     Rev 1.24   27 Jan 2006 14:31:18   SMcBrayer
...
$projectPEs{"NBASE"} = "Jaci.collins, Grace.Pena";
...
$projectPEs{"NBUYPASS"} = "stephen.mcbrayer";
...
$projectPrefixes{"NBPEPS"} = "bp";
$projectExists{"NBPEPS"} = 1;
$projectNames{"BP"} = "NBPEPS";
$projectShares{"NBPEPS"} = "NBPEPS";
$projectDrives{"NBPEPS"} = "S:";
$projectPEs{"NBPEPS"} = "Alan.Ott";

$projectPrefixes{"NFD"} = "fd";
$projectExists{"NFD"} = 1;
$projectNames{"FD"} = "NFD";
$projectShares{"NFD"} = "NFD";
$projectDrives{"NFD"} = "S:";
$projectPEs{"NFD"} = "baolin.li";

$projectPrefixes{"NGP"} = "GP";
$projectExists{"NGP"} = 1;
$projectNames{"GP"} = "NGP";
$projectShares{"NGP"} = "NGP";
$projectDrives{"NGP"} = "S:";
$projectPEs{"NGP"} = "Scott.Rice";
...
sub processCOMInteropDLLList
{
   ...
   while ($_ = pop(@DLLList))
   {
      s/\n//; #strip newline
      $curDLL = "$DLLDir\\$_";
      $regCmd = "c:\\windows\\microsoft.net\\framework\\v2.0.50727\\regasm /silent /codebase /tlb $unregisterSwitch $curDLL";
      print "$regCmd\n";
      `$regCmd`;
      if ($?)
      {
