@echo off
rem ***************************************************************************************
rem *Header: mySCMLinkChecker.bat, v1.0, 2/22/2008 mha                                                                           *
...
rem *
rem * Usage: mySCMLinkChecker.bat web
rem *     where:
...
set LOG=c:\hScripts\logs\SCManagementLinkCheck_%date:~10,4%-%date:~4,2%-%date:~7,2%_%hour%_%minute%_%second:~0,2%.log
...
linkchecker.bat -v -o text http://hardev3:8098/SCManagement/ > %LOG%
...
linkchecker -v -o text http://hardev3:8080/SCManagement/ > %LOG%
