...
/****************************************************************************************/
/*                                                                                      */
/* Star 15518617 : TNGAMO: change procedure use_trg_d_agent_usd_rel 			*/
/*                                                                                      */
/****************************************************************************************/
...
Select top 1 1 from ca_agent with (tablockx)
GO
...
ALTER  trigger usd_trg_d_agent_usd_rel
on ca_agent
for delete as
declare
    @counted int
...
insert into mdb_patch ( patchnumber, installdate,  mdbmajorversion, mdbminorversion, description)
 values ( 15518617, getdate(), 1, 4, 'Star 15518617 : TNGAMO: change procedure use_trg_d_agent_usd_rel' )
GO
