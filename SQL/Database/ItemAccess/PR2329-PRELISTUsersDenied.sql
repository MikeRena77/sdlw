...
-- Before conversion: Users DENIED access to items
...
FROM 
  ...
  HARITEMS IT, 
  HARPATHFULLNAME PF,
  ( SELECT DISTINCT UG.UsrObjId, IA.ItemObjId FROM HARITEMACCESS IA, HARUSERSINGROUP UG WHERE IA.UsrGrpObjId = UG.UsrGrpObjId AND IA.ViewAccess = 'N' ) IA1
WHERE 
