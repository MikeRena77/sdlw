...
set HAR_NAME=scmuser
set HAR_PASS=scmuser
set DBA_NAME=system
set DBA_PASS=manager@scmuser
set DUMPED_FILE=proddbs1Exp.dmp
set DUMPED_USER=hrvstuser
set DataSrc=SCMUSER
...
set HARVESTMETAFILE=c:\SCM_Tables\SCMMETAFILE.ora
set HARVESTBLOBFILE=c:\SCM_Tables\SCMBLOBFILE.ora
set HARVESTINDEXFILE=c:\SCM_Tables\SCMINDEXFILE.ora
